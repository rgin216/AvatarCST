...
The seven criteria assess script adherence, relevance, accessibility, respect, grounding, handling difficulty and continuity. Critics receive final text and session context without facilitator identity or raw generation output. Each critic must return valid scores and evidence; invalid responses never become zero scores. Oversized evidence fails rather than being silently truncated.
