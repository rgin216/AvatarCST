...
export function createFacesScenesScript(shared) {
  ...
  return [
    ...
    discussion('celebrities_different', 19, 'What is different about these three people?', 'What differences do you notice between Billy T James, Dame Kiri Te Kanawa, and Elvis Presley?', celebrities,
      'Possible answers include directly observable differences in clothing and hairstyles. Accept a reasonable observation without inferring private attributes or listing every difference.'),
